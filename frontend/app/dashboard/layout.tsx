...
export default function DashboardLayout({
    ...
    return (
        <div className="flex h-screen bg-zinc-50 dark:bg-zinc-950 transition-colors duration-300">
            ...
            <main className={`flex-1 lg:ml-64 p-4 lg:p-8 pt-20 lg:pt-8 overflow-y-auto w-full text-zinc-900 dark:text-zinc-100 transition-all duration-300 min-h-screen`}>
